...
class Completed_transaction_Buyer extends StatefulWidget {
  static String id='Completed_transaction_Buyer_Screen';
  @override
  _Completed_transaction_BuyerState createState() => _Completed_transaction_BuyerState();
}

class _Completed_transaction_BuyerState extends State<Completed_transaction_Buyer> {
  String UserUID=_auth.currentUser.uid.toString();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection("Transactions").where("BuyerUID",isEqualTo:UserUID).where("Book_Taken_from_Buyer",isEqualTo: true).snapshots(),
